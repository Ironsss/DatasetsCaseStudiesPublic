...
- **Dataset 23andMe:** Basado en el caso de estudio de 23andMe (genómica directa al consumidor en EE. UU.), donde se aborda el reto de traducir datos genéticos al público de forma segura y comprensible. El conjunto de datos incluye variables clínicas básicas (edad, IMC, presión arterial, lípidos, glucosa, HbA1c), marcadores agregados como puntuación poligénica (PRS), métricas de laboratorio (ALT, AST, creatinina, eGFR, PCR), hábitos (ejercicio, tabaquismo) y metadatos de producto (consentimiento por propósito, participación en “parientes de ADN” opt-in).
